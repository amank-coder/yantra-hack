...
const Home = () => {
  ...
  <section className='bg-gradient-to-r from-purple-800 to-indigo-800 pb-[50px] py-16'>
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center'>
            <h1 className='text-3xl font-extrabold text-white'>Our Features</h1>
            <p className='mt-4 text-xl text-gray-300'>We offer a variety of services</p>
        </div>

        <div className='mt-12 grid grid-cols-1 gap-8 md:girid-cols-2 lg:grid-cols-3'>
            <ServiceCard title="Multi-lingual" text="Supports course content in regional language" image="/multi.jpg" background="/multi.jpg"/>
            <ServiceCard title="AI Tutor" text="AI-assisted smart doubt resolution" image="/s1.jpg" background="/s1.jpg"/>
            <ServiceCard title="Course Worthiness" text="Know the worth of the course" image="/multi.jpg" background="/worth.jpg"/>

        </div>
    </div>
  </section>

      <footer className='flex bg-gradient-to-r from-[#f600fe] via-[#a136ff] to-[#0033d9] text-white justify-center mt-16'>
        <div className="pt-8 bottom-0 px-[20px] md:px-[60px] 2xl:px-[110px] flex flex-col md:flex-row gap-36">
            <div className='flex flex-col'>
                <div className='bg-white mt-8 rounded-full w-48 mx-auto'>
                    <img src='/logo.png' alt='logo'/>
