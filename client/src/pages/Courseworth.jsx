...
const Courseworth = () => {
  ...
  const handleCourseClick = async(course) => {
    ...
    const { data } = await axios.post('http://127.0.0.1:5000/discription',{target:lang});
  ...
  const handleSubmit = async()=>{
    console.log(query);
    const { data } = await axios.post('http://127.0.0.1:5000/worth',{query,target:lang});
  ...
  Your browser does not support the video tag.
        ...
        <span className='font-semibold realtive top-4'>{t('techStack')} </span><span>[Generated by AI]: </span><br />
        <span>
        { 
        ...
        <span className='font-semibold'>{t('topicsCovered')}</span><span>[Generated by AI]: </span><br /><span>
